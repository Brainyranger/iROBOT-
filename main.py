...
IA_tourne_gauche = Tourner(0.03,90,30,simul.robot,"gauche")
...
IA_exo21 = IA([IA_avance_2cm,IA_tourne_g45,IA_avance_5cm,IA_tourne_droit,IA_avance_5cm,IA_tourne_g45,IA_avance_2cm])
#exo 2.2:
